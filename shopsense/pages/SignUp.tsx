    ...
    <div className="w-full h-100">
      ...
      <form className="mt-6" action="#" method="POST">
         <div>
          ...
          <input type="name" name="" id="" placeholder="Enter Name" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none"  required />
        </div>
        <div className="mt-4">
        ...
        <div className="text-right mt-2">
          <a href="/ForgotPassword" className="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700">Forgot Password?</a>
        </div>
      ...
      <p className="mt-8">Already account? <a href="/Login" className="text-blue-500 hover:text-blue-700 font-semibold">Login</a></p>
