  ...
  return (
    <div>
      <div className="h-[auto] bg-gray-100 pt-20">
        <h1 className="mb-10 text-center text-black text-2xl font-bold">
          Cart Items
        </h1>
        {cartitems.length === 0 ? (
          <h1 className="text-black h-screen text-center pt-[10%]">
            OOPS! Cart is empty
          </h1>
        ) : (
                        ...
                        <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                          <div className="flex items-center border-gray-100">
                            <span
                              ...
                              className=" text-black cursor-pointer rounded-l bg-gray-100 py-1 px-3.5 duration-100 hover:bg-blue-500 hover:text-blue-50"
                            >
                              {" "}
                              -{" "}
                            </span>
                            ...
                            <span
                              ...
                              className=" text-black cursor-pointer rounded-r bg-gray-100 py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50"
                            >
                              {" "}
                              +{" "}
                            </span>
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <svg
                              ...
                              stroke-width="1.5"
                              stroke="currentColor"
                              className="h-5 w-5 text-red-500 cursor-pointer duration-150 hover:text-red-300"
                            >
                              <path
