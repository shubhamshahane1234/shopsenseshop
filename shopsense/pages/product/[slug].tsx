          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed">
                Elevate your athletic performance with the shopsense Performance
                Running Shoes, meticulously designed to meet the demands of both
                seasoned runners and fitness enthusiasts. Crafted with precision
                and cutting-edge technology, these sport shoes deliver an
                optimal blend of comfort, support, and style.
              </p>
              ...
              <div className="flex mt-6 items-center   border-gray-100 mb-2 ">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="pincode avaibility"
                    pattern="^\d{5}(-\d{4})?$"
                    required
                  />
                </div>
              ...
              {service && service != null && (
                ...
                >
                  hooray ! we deliver to this code
                </p>
              )}
              {!service && service != null && (
                <p
